#pragma checksum "C:\Users\eaydin\Documents\GitHub\EPazar\EPazar\BigtarzPanel\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ffe6c8da9e9239d3386ef6f3d91e9e2765252e16"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ffe6c8da9e9239d3386ef6f3d91e9e2765252e16", @"/Views/Home/Index.cshtml")]
  ...
  ");
            WriteLiteral(@"                          <div class=""d-flex justify-content-between flex-wrap"">
                                <div>
                                    <div class=""card-title mb-0"">Toplam Satış</div>
                                ...
                                <div>
                                    <div class=""d-flex flex-wrap pt-2 justify-content-between sales-header-right"">
                                        <div class=""d-flex mr-5"">
                                            ...
                                            <div class=""pl-2"">
                                                <h4 class=""mb-0 font-weight-semibold head-count""> 0 </h4>
                                              ");
            WriteLiteral(@"  <span class=""font-10 font-weight-semibold text-muted"">Toplam Sipariş Adedi</span>
                                            </div>
                                        </div>
                                        <div class=""d-flex mr-3 mt-2 mt-sm-0"">
                                            ...
                                            <div class=""pl-2"">
                                                <h4 class=""mb-0 font-weight-semibold head-count""> 0 </h4>
                                                <span class=""font-10 font-weight-semibold text-muted"">Toplam Sipariş</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            WriteLiteral(@"             </div>
                            <p class=""text-muted font-13 mt-2 mt-sm-0"">
                                Satışlar istatistik olarak burada gözükür.
                            </p>
            ...
            WriteLiteral(@"=""table-responsive"">
                                <table class=""table custom-table text-dark table-hover"">
                                    <thead>
                                        <tr>
                        ...
                        <div class=""card-body"">
                            <div class=""d-flex justify-content-between"">
                                <div class=""card-title"">
                                    Üye Bilgisi <small class=""d-block text-muted"">Başlangıçtan - Bugüne</small>
                                </div>
                                <div class=""d-flex ");
            WriteLiteral(@"text-muted font-20"">
                                    <i class=""mdi mdi-printer mouse-pointer""></i>
                                    <i class=""mdi mdi-help-circle-outline ml-2 mouse-pointer""></i>
                                </div>
                            </div>
                            <h3 class=""font-weight-bold mb-0"">
                                0 <span class=""text-success h5""><i class=""mdi mdi-arrow-up""></i></span>
                            </h3>
                            <span class=""text-muted font-13"">Toplam Üye Sayısı</span>
            ...
            WriteLiteral(@"=""d-flex justify-content-between"">
                                <div class=""card-title"">
                                    Site Ziyaretleri <small class=""d-block text-muted"">Başlangıçtan - Bugüne</small>
                                </div>
                            ...
                            <h3 class=""font-weight-bold mb-0"">
                                20 <span class=""text-success h5""><i class=""mdi mdi-arrow-up""></i></span>
                            </h3>
                            <span class=""text-muted font-13"">Günlük Ortalama Ziyaret</span>
    ...
    ");
            ...
            <h3 class=""col-md-12 col-12 col-sm-12  font-weight-bold mb-0"">
                Yeni Eklenenler<span class=""text-success h5""><i class=""mdi mdi-new-box"" style=""font-size: 33px""></i></span>

                <div class=""row"">
                    <div class=""col-sm-4 stretch-card grid-margin"">
                        <div class=""card"">
                            <div class=""card-body p-0"">
                                <img class=""img-fluid w-100"" src=""../assets/images/dashboard/img_1.jpg""");
            BeginWriteAttribute("alt", " alt=\"", 9916, "\"", 9922, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
                            </div>
                            <div class=""card-body px-3 text-dark"">
                                <div class=""d-flex justify-content-between"">
                                    <p class=""text-muted font-13 mb-0"">Mağaza Adı</p>
                                    <i class=""mdi mdi-heart-outline""></i>
                                </div>
                                <h5 class=""font-weight-semibold""> Ürün Adı </h5>
                    ...
                    <div class=""col-sm-4 stretch-card grid-margin"">
                        <div class=""card"">
                            <div class=""card-body p-0"">
                              ");
            WriteLiteral("  <img class=\"img-fluid w-100\" src=\"../assets/images/dashboard/img_1.jpg\"");
            BeginWriteAttribute("alt", " alt=\"", 11020, "\"", 11026, 0);
            EndWriteAttribute();
            WriteLiteral(@" />
                            </div>
                            <div class=""card-body px-3 text-dark"">
                          ...
                          <div class=""col-md-4"">
                            <div class=""card border-0"">
                              <div class=""card-body"">
                                ...
                                <div class=""d-flex flex-wrap"">
         ");
            WriteLiteral(@"                         <div class=""doughnut-wrapper w-50"">
            ...
            WriteLiteral(@"19</h3>
                          ...
                          <div class=""d-flex border-bottom py-3"">
                            ...
                            <div class=""pl-2"">
           ");
            WriteLiteral(@"                   <span class=""font-12 text-muted"">Mon, Mar 11, 4.30 PM</span>
                          ...
                          <div class=""d-flex pt-3"">
                            <div class=""form-check"">
                              <label class=""form-check-label"">
     ");
            WriteLiteral(@"                           <input type=""checkbox"" class=""form-check-input"" /></label>
                            </div>
                            <div class=""pl-2"">
            ...
            WriteLiteral(@"n"">
                          ...
                          <div class=""d-flex border-bottom mb-4 pb-2"">
                            ...
                            <div class=""pl-4"">
                              ...
                              <h6 class=""text-muted""");
            WriteLiteral(@">Schedule Meeting</h6>
                            </div>
                          </div>
                          <div class=""d-flex"">
                            <div class=""hexagon"">
                    ...
                    <div class=""col-sm-6 col-xl-4 stretch-card grid-margin"">
                      <div class=""card color-card-wrapper"">
                        <div class=""card-body"">
                          <img class=""img-fluid card-to");
            WriteLiteral(@"p-img w-100"" src=""../assets/images/dashboard/img_5.jpg"" alt="""" />
