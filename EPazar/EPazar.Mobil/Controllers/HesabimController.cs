...
namespace EPazar.M.Controllers
{
    [Authorize]
    public class HesabimController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewData["Email"] = HttpContext.User.FindFirstValue(ClaimTypes.Email) != null ? HttpContext.User.FindFirstValue(ClaimTypes.Email) : "";
            return View();
        }
        ...
        public async Task<IActionResult> HesapBilgileri(Kullanicilar kullanicilar)
        {
            ...
            kullanicilar.EMail = Kullanicilar.EMail;
        ...
        public async Task<IActionResult> AdresBilgilerim()
        {
            Kullanicilar.EMail = HttpContext.User.FindFirstValue(ClaimTypes.Email) != null ? HttpContext.User.FindFirstValue(ClaimTypes.Email) : null;
            ...
            List<KullaniciAdresleri> ListKullaniciAdresleri = new List<KullaniciAdresleri>();
            ListKullaniciAdresleri= await BusKullaniciAdresleri.PredicateAsync(KullaniciAdresleri);

            return View(ListKullaniciAdresleri);
        }
